...
import { Target, Zap, BarChart3, TrendingUp, Globe, ArrowRight, ShieldCheck } from 'lucide-react';
import { Link } from 'react-router-dom';

export default function MarketingPage() {
  const points = [
    { icon: <TrendingUp className="text-gk-accent" />, title: "ROI Maximization", desc: "We focus on high-intent conversion nodes that drive direct revenue growth." },
    { icon: <Target className="text-gk-accent" />, title: "Precision Targeting", desc: "Reaching decision-makers and high-ticket patients with clinical accuracy." },
    { icon: <Zap className="text-gk-accent" />, title: "Performance Loops", desc: "Continuous A/B testing and algorithmic adjustments for maximum yield." },
  ];
    ...
    <div className="min-h-screen bg-gk-bg text-gk-text1">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              ...
              >
                 ...
                 <h1 className="text-5xl md:text-8xl font-bold mb-10 leading-[1.05]">
                   Performance <span className="gradient-gold">Marketing.</span>
                 </h1>
                 <p className="text-gk-text2 text-xl leading-relaxed max-w-xl mb-12 font-body">
                   We engineer aggressive growth campaigns for ambitious brands. Our focus is on the metrics that actually impact your bottom line.
                 </p>
                 <Link to="/contact" className="inline-flex py-5 px-12 bg-white text-black font-bold text-xs uppercase tracking-widest hover:bg-gk-accent transition-all">
                   Initialize Campaign Audit
                 </Link>
              </motion.div>
      ...
      <section className="py-52 px-6 text-center border-t border-gk-border">
        <div className="container-custom max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-7xl font-bold mb-12 leading-tight">Dominate Your <span className="gradient-gold">Market Node</span> Today.</h2>
