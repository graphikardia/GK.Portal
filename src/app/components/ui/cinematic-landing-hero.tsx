...
export interface CinematicHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  badge1?: { icon: string; title: string; subtitle: string };
  badge2?: { icon: string; title: string; subtitle: string };
}
...
export function CinematicHero({ 
  ...
  cardDescription = <><span className="text-[#DC143C] font-semibold">GK</span> helps ambitious businesses scale with strategic digital marketing, stunning design, and cutting-edge development.</>,
  metricValue = 365,
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-screen h-screen overflow-hidden flex items-center justify-center bg-white text-[#0a0a0a] font-sans antialiased", className)}
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#" aria-label="Download on the App Store" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
          ...
          <a href="#" aria-label="Get it on Google Play" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-background">
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Analytics</span>
                        </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-red-500/20 to-red-100/10 flex items-center justify-center border border-red-400/30 shadow-inner">
                    <span className="text-base lg:text-xl drop-shadow-lg" aria-hidden="true">{badge1?.icon || "🔥"}</span>
                  </div>
                  <div>
                    <p className="text-[#0a0a0a] text-xs lg:text-sm font-bold tracking-tight">{badge1?.title || "1 Year Streak"}</p>
                    <p className="text-[#0a0a0a]/50 text-[10px] lg:text-xs font-medium">{badge1?.subtitle || "Milestone unlocked"}</p>
                  </div>
                </div>

                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-red-500/20 to-red-100/10 flex items-center justify-center border border-red-400/30 shadow-inner">
                    <span className="text-base lg:text-lg drop-shadow-lg" aria-hidden="true">{badge2?.icon || "🤝"}</span>
                  </div>
                  <div>
                    <p className="text-[#0a0a0a] text-xs lg:text-sm font-bold tracking-tight">{badge2?.title || "Sponsor Update"}</p>
                    <p className="text-[#0a0a0a]/50 text-[10px] lg:text-xs font-medium">{badge2?.subtitle || "Shared successfully"}</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              ...
              <p className="text-[#0a0a0a]/70 text-sm md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none">
                {cardDescription}
              </p>
            </div>
